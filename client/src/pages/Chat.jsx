...
console.log("Converted Successfully");`;
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white transition-colors duration-300">
      ...
      {/* Input */}
      <div className="border-t border-gray-200 dark:border-gray-700 mt-10 mb-6">
        <div className="max-w-3xl mx-auto flex items-center gap-3 mt-6">
          <input
            type="text"
            value={message}
            ...
            className="w-full px-5 py-3 rounded-full bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-orange-500 shadow-sm"
          />
