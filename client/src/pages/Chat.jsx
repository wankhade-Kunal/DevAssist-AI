...
console.log("Converted Successfully");`;
  ...
  return (
    <div className="h-screen flex flex-col bg-white dark:bg-gray-900 text-gray-900 dark:text-white transition-colors duration-300">
      ...
      <div className="flex-1 overflow-y-auto" ref={messagesRef}>
        <div className="w-full max-w-3xl mx-auto px-4 py-6 space-y-4">
          {/* Empty State */}
          {chat.length === 0 && (
            <div className="max-w-3xl mx-auto text-center flex flex-col justify-center items-center min-h-[60vh] gap-4">
          ...
          {chat.map((msg, index) => (
            ...
            >
              <div
                className={`px-4 py-2 rounded-xl max-w-[70%] relative shadow-md ${
                  msg.role === "user"
          ...
          {loading && (
            <div className="flex justify-start">
              <div className="bg-gray-100 dark:bg-gray-800 px-4 py-2 rounded-xl animate-pulse text-gray-600 dark:text-gray-400 flex items-center gap-2">
                Thinking...
              </div>
            </div>
          )}
      ...
      <div className="sticky bottom-0 bg-white dark:bg-gray-900 border-t">
        <div className="max-w-3xl mx-auto flex gap-3 p-4">
          <input
            ...
            className="flex-1 px-5 py-3 rounded-full bg-gray-100 dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-orange-500 shadow-sm"
          />

          <button
            onClick={sendMessage}
            disabled={loading}
            className="px-6 py-3 rounded-full bg-orange-500 hover:bg-orange-600 text-white font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg flex items-center gap-2"
          >
            <Send size={16} />
            Send
          </button>
